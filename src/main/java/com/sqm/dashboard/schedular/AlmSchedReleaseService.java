...
public interface AlmSchedReleaseService {
	...
	public List<String> getAlmReleasesIds(RestConnectorUtility conn, 
											String releasesUrl, 
											Map<String, String> requestHeaders) throws Exception;
	
	public List<String> getAlmReleasesNames(RestConnectorUtility conn, 
											String releasesUrl, 
											Map<String, String> requestHeaders) throws Exception;
	
	public ArrayList<String> getAlmReleaseCycleNames(RestConnectorUtility conn, 
