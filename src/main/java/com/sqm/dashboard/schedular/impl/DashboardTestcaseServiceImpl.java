...
public class DashboardTestcaseServiceImpl implements DashboardTestcaseService {
	
	static final Log log = LogFactory.getLog(DashboardTestcaseServiceImpl.class);
	
	@Autowired
	SchedularTCExecStatusVO schedularTCExecStatusVO;
...
*/
	...
	public String getAlmTestcases(RestConnectorUtility conn, Map<String, String> requestHeaders, String testcasesUrl, String releaseId) {
		...
		return schedularTCExecStatusVO.toString();
	}
