...
public class DashboardDefectServiceImpl implements DashboardDefectService {
	
	static final Log log = LogFactory.getLog(DashboardDefectServiceImpl.class);
	
	@Autowired
	SchedularDefectsVO schedularDefectsVO;
	...
	public String getAlmDefects(RestConnectorUtility conn, Map<String, String> requestHeaders, String defectsUrl, String releaseId) {
		...
		return schedularDefectsVO.toString();
	}
